    ...
    <>
      <section className="py-10 bg-primary text-white w-full overflow-hidden">
        <div className="container relative hidden sm:block">
          ...
          {/* Recommended Articles Cards section */}
          <div className="relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-2 gap-4 mt-8">
                    ...
                    <div className="flex justify-center items-center gap-4 bg-gradient-to-t from-primary to-transparent">
                      ...
                      <div>
                        <h1 className="font-semibold text-xl">
                          ...
                          elit. Ducimus consequuntur aut, dolores recusandae
                          illum modi exercitationem.{" "}
                        </h1>
              ...
              <div
                style={game3Cover}
                className="bg-blue-500 rounded-xl relative"
              >
                <div className="bg-black/20 h-full w-full">
                  <div className="absolute bottom-0 left-0 w-full">
                    <div className="flex justify-center items-center gap-4 bg-gradient-to-t from-primary to-transparent">
          ...
          <img
            src={CharacterPng}
            alt="not found"
            className="absolute right-[-160px] top-[50px] z-[11] h-[340px]"
          />
        </div>
      </section>
    </>
